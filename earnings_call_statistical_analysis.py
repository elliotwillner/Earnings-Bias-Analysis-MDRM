...
# Load audio feature dictionaries and genders
...
#print("Audio feature dictionary (audio_featDict):", audio_featDict)
#print("Audio feature dictionary (audio_featDictMark2):", audio_featDictMark2)
...
def ModifyData(df, genders=None):
    ...
    for index, row in df.iterrows():
        ...
        try:
            ...
            if genders is not None:
                if genders[row['gender']] == 'M':
                    X_male.append(lstm_matrix_temp)
                elif genders[row['gender']] == 'F':
        ...
        if row['text_file_name'] != 'DTE Energy Co._20170726' and genders is not None:
...
# Modify data and assign results to variables
...
for i in range(X_male.shape[-1]):
    ...
    t, p = stats.ttest_ind(male_avg, female_avg)
